...
class NewsCacheManager extends BaseCacheManager {
  static const key = "newsCacheManager";

  static NewsCacheManager _instance;

  /// The NewsCacheManager that can be easily used directly. The code of
  /// this implementation can be used as inspiration for more complex cache
  /// managers.
  factory NewsCacheManager() {
    if (_instance == null) {
      _instance = new NewsCacheManager._();
    }
    return _instance;
  }

  NewsCacheManager._() : super(key);
...
abstract class BaseCacheManager {
  ...
  BaseCacheManager(this._cacheKey,
      {Duration maxAgeCacheObject = const Duration(days: 1),
